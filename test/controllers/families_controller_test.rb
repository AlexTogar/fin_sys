...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create family' do
    assert_difference('Family.count') do
      post families_url, params: { family: { connect: @family.connect, deleted: @family.deleted, name: @family.name, user: @family.user } }
    end
  ...
  test 'should update family' do
    patch family_url(@family), params: { family: { connect: @family.connect, deleted: @family.deleted, name: @family.name, user: @family.user } }
